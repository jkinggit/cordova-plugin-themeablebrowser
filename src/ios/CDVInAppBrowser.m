...
- (void)open:(CDVInvokedUrlCommand*)command
{
    ...
    if(browserOptions.usewkwebview && !self.wkwebviewavailable){
        [self.commandDelegate sendPluginResult:[CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsDictionary:@{@"type":@"loaderror", @"message": @"usewkwebview option specified but cordova-plugin-wkwebview-engine not present"}] callbackId:command.callbackId];
        return;
    }
